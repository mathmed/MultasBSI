...
import NovoRelato from './components/NovoRelato.js';
		...
		return(
			<Router navigationBarStyle={{ backgroundColor: '#fff' }} titleStyle={{ color: '#ff5400' }}>
				<Scene key = 'root'>
					...
					<Scene key = 'home' component = {Home} hideNavBar headerTintColor="snow"/>
					...
					<Scene key = 'relato' component = {NovoRelato}  title="Novo relato" titleStyle = {{color: 'snow', backgroundColor: '#FFE518', fontSize: 16}} hideNavBar = {false} navigationBarStyle={{backgroundColor: '#FFE518', height: 40}} headerTintColor="snow"/>
					...
					<Scene key = 'sobre' component = {Sobre}  title="Sobre" titleStyle = {{color: 'snow', backgroundColor: '#E82D0C', fontSize: 16}} hideNavBar = {false} navigationBarStyle={{backgroundColor: '#E82D0C', height: 40}} headerTintColor="snow"/>
				</Scene>
			</Router>
